"""Smoke test for Luna AI via OpenAI Responses protocol."""
...
@pytest.mark.asyncio
async def test_luna_responses_smoke():
    """Smoke test: Luna AI gpt-5.6-luna via OpenAI Responses protocol."""
    credential_file = os.environ.get("PRP_TEST_CREDENTIAL_FILE")
    assert credential_file, "PRP_TEST_CREDENTIAL_FILE not set"

    provider = create_provider(
        profile_name="LUNA_RESPONSES",
