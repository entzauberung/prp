"""Smoke test for DeepSeek via Anthropic Messages protocol."""
...
@pytest.mark.asyncio
async def test_deepseek_anthropic_smoke():
    """Smoke test: DeepSeek deepseek-v4-flash via Anthropic Messages protocol."""
    credential_file = os.environ.get("PRP_TEST_CREDENTIAL_FILE")
    assert credential_file, "PRP_TEST_CREDENTIAL_FILE not set"

    provider = create_provider(
        profile_name="DEEPSEEK_ANTHROPIC",
